...
class GameManager:
    def __init__(self, ball_group, p_group):
        self.player_score = 0
    ...
    def run_game(self):
        ...
        self.p_group.draw(screen)
        self.ball_group.draw(screen)

        # Update the game objects
        self.p_group.update(self.ball_group)
...
# Sounds
plob_url = resource_path("pong.ogg")
plob_sound = pygame.mixer.Sound(plob_url)
score_url = resource_path("score.ogg")
score_sound = pygame.mixer.Sound(score_url)


# Game Objects
paddle_url = resource_path("Paddle.png")
player = Player(paddle_url, screen_width - 20, screen_height / 2, 5)
opponent = Opponent(paddle_url, 20, screen_width / 2, 5)
paddle_group = pygame.sprite.Group()
paddle_group.add(player)
paddle_group.add(opponent)

ball_url = resource_path("Ball.png")
ball = Ball(ball_url, screen_width / 2, screen_height / 2, 4, 4, paddle_group)
